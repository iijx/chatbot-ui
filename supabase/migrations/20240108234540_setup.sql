...
AS $$
DECLARE
  project_url TEXT := 'https://zugmndoqyghcgdiovnmi.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Inp1Z21uZG9xeWdoY2dkaW92bm1pIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcwNzQ4MzE0NiwiZXhwIjoyMDIzMDU5MTQ2fQ.elGJEZyAp4Rlb4QrvyikGEdcs9Z7WC9i07wg4Kk6-fM'; -- full access needed for http request to storage
